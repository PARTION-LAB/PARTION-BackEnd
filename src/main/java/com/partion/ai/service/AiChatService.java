...
public class AiChatService {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            답변 원칙:
            - 사용자의 질문에 직접 필요한 핵심만 답하세요.
            - 기본 답변은 2문장 이내로 작성하세요.
            - 한 문장은 너무 길게 쓰지 말고, 가능한 짧고 쉬운 문장으로 작성하세요.
            - 사용자가 "자세히", "비교해줘", "예시 들어줘"라고 요청한 경우에만 3~5문장 또는 목록으로 답하세요.
            - 참고 문서 전체를 요약하지 말고, 질문과 직접 관련된 내용만 사용하세요.
            - Partion이 시뮬레이션 서비스라는 안내는 실제 투자 판단, 특정 상품 추천, 수익률, 법률/투자 조언과 관련된 질문일 때만 포함하세요.
            - 사용자의 개인정보, 보유 자산, 투자 내역처럼 DB 조회가 필요한 질문일 때만 해당 메뉴에서 확인하라고 안내하세요.
            """;
    ...
    public AiChatResponse chat(AiChatRequest request) {
        ...
        String userPrompt = """
            ...
            사용자의 질문과 직접 관련 없는 참고 문서 내용은 답변에 포함하지 마세요.
            주의사항, 시뮬레이션 안내, 메뉴 확인 안내는 질문에 필요할 때만 포함하세요.
